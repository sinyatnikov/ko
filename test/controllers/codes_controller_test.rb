...
class CodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post codes_url, params: { code: { description: @code.description, info: @code.info, name: @code.name } }
    end
  ...
  test "should update code" do
    patch code_url(@code), params: { code: { description: @code.description, info: @code.info, name: @code.name } }
